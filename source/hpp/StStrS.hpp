...
extern DELPHI_PACKAGE bool __fastcall Str2Int16S(const System::ShortString &S, short &I);
extern DELPHI_PACKAGE bool __fastcall Str2WordS(const System::ShortString &S, System::Word &I);
extern DELPHI_PACKAGE bool __fastcall Str2LongS(const System::ShortString &S, int &I);
extern DELPHI_PACKAGE bool __fastcall Str2RealS(const System::ShortString &S, double &R);
extern DELPHI_PACKAGE bool __fastcall Str2ExtS(const System::ShortString &S, System::Extended &R);
...
extern DELPHI_PACKAGE System::ShortString __fastcall ValPrepS(const System::ShortString &S);
...
extern DELPHI_PACKAGE System::ShortString __fastcall LeftPadChS(const System::ShortString &S, char C, unsigned Len);
extern DELPHI_PACKAGE System::ShortString __fastcall LeftPadS(const System::ShortString &S, unsigned Len);
...
extern DELPHI_PACKAGE System::ShortString __fastcall TrimSpacesS(const System::ShortString &S);
...
extern DELPHI_PACKAGE bool __fastcall StrChPosS(const System::UnicodeString P, System::WideChar C, unsigned &Pos)/* overload */;
extern DELPHI_PACKAGE bool __fastcall StrChPosS(const System::ShortString &P, char C, unsigned &Pos)/* overload */;
...
extern DELPHI_PACKAGE System::ShortString __fastcall StrChInsertS(const System::ShortString &S, char C, unsigned Pos);
...
extern DELPHI_PACKAGE System::ShortString __fastcall StrChDeleteS(const System::ShortString &S, unsigned Pos);
extern DELPHI_PACKAGE System::ShortString __fastcall StrStDeleteS(const System::ShortString &S, unsigned Pos, unsigned Count);
...
extern DELPHI_PACKAGE System::ShortString __fastcall ReplaceStringAllS(const System::ShortString &S, const System::ShortString &OldString, const System::ShortString &NewString, unsigned &Replacements);
...
extern DELPHI_PACKAGE unsigned __fastcall ExtractTokensS(const System::ShortString &S, const System::ShortString &Delims, char QuoteChar, bool AllowNulls, System::Classes::TStrings* Tokens);
...
extern DELPHI_PACKAGE bool __fastcall IsChAlphaNumericS(System::WideChar C, const System::ShortString &Numbers);
