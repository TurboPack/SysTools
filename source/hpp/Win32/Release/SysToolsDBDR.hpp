...
// (DO NOT EDIT: machine generated header) 'SysToolsDBDR.dpk' rev: 33.00 (Windows)
...
namespace Systoolsdbdr
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Systoolsdbdr */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_SYSTOOLSDBDR)
using namespace Systoolsdbdr;
#endif
#pragma pack(pop)
#pragma option pop
