...
// (DO NOT EDIT: machine generated header) 'SysToolsDD.dpk' rev: 28.00 (Windows)
...
#include <StReg.hpp>	// Pascal unit
#include <StPropEd.hpp>	// Pascal unit
#include <StAbout0.hpp>	// Pascal unit
