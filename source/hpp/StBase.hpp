...
extern DELPHI_PACKAGE void __fastcall ValLongInt(System::ShortString &S, int &LI, int &ErrorCode);
extern DELPHI_PACKAGE void __fastcall ValSmallint(const System::ShortString &S, short &SI, int &ErrorCode);
extern DELPHI_PACKAGE void __fastcall ValWord(const System::ShortString &S, System::Word &Wd, int &ErrorCode);
