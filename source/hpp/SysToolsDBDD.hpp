...
// (DO NOT EDIT: machine generated header) 'SysToolsDBDD.dpk' rev: 28.00 (Windows)
...
#include <StRegDb.hpp>	// Pascal unit
...
namespace Systoolsdbdd
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Systoolsdbdd */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_SYSTOOLSDBDD)
using namespace Systoolsdbdd;
#endif
#pragma pack(pop)
#pragma option pop
