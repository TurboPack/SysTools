...
// (DO NOT EDIT: machine generated header) 'StNetAPI.pas' rev: 31.00 (Windows)
...
typedef System::StaticArray<TNET_DISPLAY_USER, 53687091> TNetDisplayUserArray;

typedef System::StaticArray<TNET_DISPLAY_GROUP, 67108863> TNetDisplayGroupArray;

typedef System::StaticArray<TUSER_INFO_3, 11671106> TUserInfo3Array;

typedef System::StaticArray<TLOCALGROUP_INFO_1, 134217727> TLocalGroupInfo1Array;

typedef System::StaticArray<TLOCALGROUP_USERS_INFO_0, 268435455> TLocalGroupUsersInfo0Array;

typedef System::StaticArray<TLOCALGROUP_MEMBERS_INFO_1, 89478485> TLocalGroupMembersInfo1Array;

typedef System::StaticArray<TLOCALGROUP_MEMBERS_INFO_2, 89478485> TLocalGroupMembersInfo2Array;

typedef System::StaticArray<TGROUP_INFO_1, 134217727> TGroupInfo1Array;

typedef System::StaticArray<TGROUP_USERS_INFO_0, 268435455> TGroupUsersInfo0Array;

typedef System::StaticArray<TShare_Info_1, 89478485> TShareInfo1Array;

typedef System::StaticArray<TMSG_INFO_0, 268435455> TMsgInfo0Array;
