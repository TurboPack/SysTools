...
// (DO NOT EDIT: machine generated header) 'StAstro.pas' rev: 31.00 (Windows)
...
//-- var, const, procedure ---------------------------------------------------
static const double radcor = 5.729578E+01;
#define StdDate  (2.451545E+06)
static const double OB2000 = 4.090928E-01;
extern DELPHI_PACKAGE double __fastcall SiderealTime(Stdate::TStDateTimeRec UT);
extern DELPHI_PACKAGE TStSunXYZRec __fastcall SunPosPrim(Stdate::TStDateTimeRec UT);
extern DELPHI_PACKAGE int __fastcall AmountOfSunlight(int LD, double Longitude, double Latitude);
extern DELPHI_PACKAGE TStPosRec __fastcall SunPos(Stdate::TStDateTimeRec UT);
...
extern DELPHI_PACKAGE TStMoonPosRec __fastcall MoonPos(Stdate::TStDateTimeRec UT);
extern DELPHI_PACKAGE TStRiseSetRec __fastcall MoonRiseSet(int LD, double Longitude, double Latitude);
extern DELPHI_PACKAGE double __fastcall LunarPhase(Stdate::TStDateTimeRec UT);
