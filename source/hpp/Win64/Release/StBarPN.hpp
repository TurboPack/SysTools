...
// (DO NOT EDIT: machine generated header) 'StBarPN.pas' rev: 31.00 (Windows)
...
public:
	...
	void __fastcall ComputeSizes(Vcl::Graphics::TCanvas* C, TStPNBarCodeRes Res, TStPNBarCodeDims &Dims);
	...
	void __fastcall SaveToFileRes(TStPNBarCodeRes Res, const System::UnicodeString FileName);
