...
// (DO NOT EDIT: machine generated header) 'StDate.pas' rev: 30.00 (Windows)
...
extern DELPHI_PACKAGE int Date1900;
extern DELPHI_PACKAGE int Date1970;
extern DELPHI_PACKAGE int Date1980;
extern DELPHI_PACKAGE int Date2000;
extern DELPHI_PACKAGE int Days400Yr;
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_STDATE)
using namespace Stdate;
#endif
#pragma pack(pop)
#pragma option pop
