...
// (DO NOT EDIT: machine generated header) 'StPQueue.pas' rev: 30.00 (Windows)
...
//-- type declarations -------------------------------------------------------
typedef System::StaticArray<void *, 268435455> TStPQData;
...
_DECLARE_METACLASS(System::TMetaClass, TStPQueueClass);
