...
// (DO NOT EDIT: machine generated header) 'StBase.pas' rev: 32.00 (Windows)
...
_DECLARE_METACLASS(System::TMetaClass, EStExceptionClass);
...
_DECLARE_METACLASS(System::TMetaClass, TStNodeClass);
